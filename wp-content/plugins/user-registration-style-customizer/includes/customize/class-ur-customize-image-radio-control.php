<?php
/**
 * Customize API: UR_Customize_Image_Radio_Control class
 *
 ...
 */
class UR_Customize_Image_Radio_Control extends WP_Customize_Control {
	...
	protected function content_template() {
		...
		<ul class="image-radio-wrapper" {{{ data.inputAttrs }}} >
