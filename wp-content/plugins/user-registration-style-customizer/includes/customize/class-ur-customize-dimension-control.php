<?php
/**
 * Customize API: UR_Customize_Dimension_Control class
 *
 * @package User_Registration_Style_Customizer\Customize
 * @since   1.0.0
 */
 ...
 */
class UR_Customize_Dimension_Control extends WP_Customize_Control {
	...
	public function get_default_inputs() {
		return array(
			'top'    => esc_attr__( 'Top', 'user-registration-style-customizer' ),
			'right'  => esc_attr__( 'Right', 'user-registration-style-customizer' ),
			'bottom' => esc_attr__( 'Bottom', 'user-registration-style-customizer' ),
			'left'   => esc_attr__( 'Left', 'user-registration-style-customizer' ),
		);
	}
}
