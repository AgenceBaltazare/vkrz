 ...
 */
function ur_style_customizer_radio_checkbox_styles_sections( $sections ) {
	return array_merge(
		$sections,
		array(
			'user_registration_radio_checkbox_style' => array(
				'title'              => __( 'Radio/Checkbox Style', 'user-registration-style-customizer' ),
				'description'        => __( 'This is radio and checkbox style description.', 'user-registration-style-customizer' ),
				'priority'           => 10,
...
add_filter( 'user_registration_style_customizer_sections', 'ur_style_customizer_radio_checkbox_styles_sections' );
/**
 * Add user registration style customizer controls.
 *
 * @param array $controls Array of controls.
 */
function ur_style_customizer_radio_checkbox_styles_controls( $controls ) {
	$controls['checkbox_radio_styles'] = array(
		...
		'alignment'       => array(
			...
			'control' => array(
				...
				'description' => __( 'This is a form field alignment only for default style.', 'user-registration-style-customizer' ),
				'section'     => 'user_registration_radio_checkbox_style',
		...
		'inline_style'    => array(
			...
			'control' => array(
				'label'       => __( 'Inline Style', 'user-registration-style-customizer' ),
				'description' => __( 'This is a form radio/checkbox inline style.', 'user-registration-style-customizer' ),
				'section'     => 'user_registration_radio_checkbox_style',
				'type'        => 'radio',
				'choices'     => array(
					'default'     => __( 'Default', 'user-registration-style-customizer' ),
					'inline'      => __( 'Inline', 'user-registration-style-customizer' ),
					'two_columns' => __( 'Two Columns', 'user-registration-style-customizer' ),
				),
			),
		),
		...
		'color'           => array(
			...
			'control' => array(
				'label'       => __( 'Radio/Checkbox Color', 'user-registration-style-customizer' ),
		...
		'checked_color'   => array(
			...
			'control' => array(
				'label'       => __( 'Radio/Checkbox Checked Color', 'user-registration-style-customizer' ),
...
add_filter( 'user_registration_style_customizer_controls', 'ur_style_customizer_radio_checkbox_styles_controls' );
