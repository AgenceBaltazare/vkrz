...
<div class="wrap download-import-templates">
	...
	<p class="description"><?php echo wp_kses_post(__('Install these import templates in your separate WP All Import installation from the <i>All Import › Settings</i> page by clicking the "Import Templates" button.', 'wp_all_export_plugin')); ?></p>
