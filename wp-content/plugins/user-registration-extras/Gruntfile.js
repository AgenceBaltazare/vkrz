module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			admin: {
				files: {
					"<%= dirs.css %>/user-regsitration-extras-admin.css": [
						"<%= dirs.css %>/select2.css",
						"<%= dirs.css %>/user-regsitration-extras-admin.css",
					],
					"<%= dirs.css %>/user-regsitration-extras-admin-rtl.css": [
						"<%= dirs.css %>/select2.css",
						"<%= dirs.css %>/user-regsitration-extras-admin-rtl.css",
					],
				},
		...
		compress: {
			options: {
				archive: "user-registration-extras.zip",
			},
			files: {
				src: [
					"**",
