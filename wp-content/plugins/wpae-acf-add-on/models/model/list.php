 ...
 */
class PMAE_Model_List extends PMXE_Model {
	...
	public function convertRecords($elementClass = NULL, $includeFields = NULL) {
		...
		if ( ! is_subclass_of($elementClass, PMAE_Plugin::PREFIX . 'Model_Record')) {
			throw new Exception("Provideded class name $elementClass must be a subclass of " . PMAE_Plugin::PREFIX . 'Model_Record');
		}
