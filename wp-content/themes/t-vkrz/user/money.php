      ...
      <div class="col-xl-9 col-lg-8 col-md-8">
        ...
        <section class="detailskeurz">
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="profileIcon-tab" data-bs-toggle="tab" href="#tab2" aria-controls="profile" role="tab" aria-selected="false">
                Vainkeur
              </a>
            </li>
            <?php if ($infos_vainkeur['user_role'] == "administrator" || $infos_vainkeur['user_role'] == "author") : ?>
              <li class="nav-item">
                <a class="nav-link" id="homeIcon-tab" data-bs-toggle="tab" href="#tab1" aria-controls="home" role="tab" aria-selected="false">
                  Créateur
                </a>
              </li>
            <?php endif; ?>
            <li class="nav-item">
              <a class="nav-link" id="homeIcon-tab" data-bs-toggle="tab" href="#tab4" aria-controls="home" role="tab" aria-selected="false">
                Parrain
              </a>
            </li>
            <li class="nav-item">
