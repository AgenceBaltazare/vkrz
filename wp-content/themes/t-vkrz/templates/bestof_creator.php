...
<div class="my-2">
  <div class="container-xxl">
    <div class="intro-archive">
      <h1>
        TOP des 20 des créateurs les plus prolifiques
      </h1>
    </div>
  </div>
  <div class="container-xxl">
                  ...
                  ?>
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="<?php the_permalink(218587); ?>?creator_id=<?php echo $creator['user_id']; ?>" class="w-100 btn btn-label-primary waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="Voir les Tops créés par <?php echo $vainkeur_data_selected['pseudo']; ?>">
                        ...
                        <td class="text-right checking-follower">
                          <?php if (get_current_user_id() != $creator['user_id']) : ?>
