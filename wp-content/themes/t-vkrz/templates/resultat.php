...
if(!$_GET['id_ranking']) {
  ...
  $id_top_global          = get_field('id_tournoi_r', $id_ranking);
    ...
    <div class="classement" data-idranking="<?= $id_ranking ?>">
      <div class="row">
        ...
        <div class="col-md-8 offset-md-2 col-10">
          <!-- TopList -->
          <div class="list-classement page-resultat">
            <div class="row align-items-end justify-content-center">
              <div class="row align-items-end justify-content-center page-resultat-ranking-js"></div>
