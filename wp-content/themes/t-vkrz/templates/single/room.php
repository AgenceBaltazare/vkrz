                                                    ...
                                                    if ($vainkeur_data_selected['user_role'] != "anonyme") : ?>
                                                        <tr id="rows" class="<?php echo "uuid" . $uuiduser; ?> uncalculated" data-idranking="<?= $id_ranking; ?>">
                                                            ...
                                                            <td class="text-right">
                                                                ...
                                                                <a href="<?php the_permalink($id_ranking); ?>#juger" class="btn btn-flat-secondary waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="Juger la TopList">
