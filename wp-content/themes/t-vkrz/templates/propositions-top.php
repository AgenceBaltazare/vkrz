  ...
  <div class="container-xxl">
    <div class="intro-archive">
      <div class="iconarchive">
        <span class="va-light-bulb va va-z-17"></span>
      </div>
      <h1>
        Propose ton idée de Top
      </h1>
      <h2>
        Si ton idée est utilisée par un créateur, tu gagneras 200 <span class="va va-gem va-md"></span>
        Tu peux aussi devenir toi même un créateur !
      </h2>
    </div>
  </div>
  <div class="container-xxl">
        ...
        <div class="col-md-9 col-12">
          <div class="heading">
            <?php if (!is_user_logged_in()) : ?>
              <p>
                Tu dois Être connecté pour proposer une idée de Top <span class="va va-doigt-droit va-2x"></span> &nbsp;<a href="<?php the_permalink(get_page_by_path('connexion')); ?>?redirect=<?php the_permalink(get_page_by_path('Proposition de Tops')); ?>" class="connect-btn nav-link btn btn-rose waves-effect waves-light">Se connecter ou s'inscrire</a>
              </p>
            <?php endif; ?>
          </div>
          <div class="row">
          ...
          <div class="separate mt-3 mb-4"></div>

          <div class="col-md-12 d-block mx-auto mt-3 p-0">
            <section id="profile-info">
              <div class="card liste-propositions-card">
                <div class="card-header p-0 mb-2">
                  <h5 class="card-title-proposition text-uppercase m-0">
                    Liste des propositions
                  </h5>
                </div>
                <div class="table-responsive">
                  <table class="table table-propositions dataTable">
                    <thead>
                      <tr>
                        <th class="text-left">
