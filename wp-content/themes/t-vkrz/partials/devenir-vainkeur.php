<section class="please-rejoin app-user-view">
  <div role="alert" aria-live="polite" aria-atomic="true" class="alert alert-account" data-v-aa799a9e="">
    <div class="alert-body d-flex align-items-center justify-content-end">
      <p>
        Je dis ça, je dis rien mais pour pas perdre ta progression, l'idéal serait de te créer un compte <span class="va va-doigt-droit va-md"></span>
      </p>
