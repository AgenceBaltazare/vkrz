...
function get_top_data($id_top)
{
  ...
  $count_votes_of_t       = intval(get_field('nb_votes_resume', $id_resume));
  $count_completed_top    = intval(get_field("nb_done_resume", $id_resume));
  $nb_top_3               = intval(get_field('nb_top_3_resume', $id_resume));
  $nb_top_complet         = intval(get_field('nb_top_complet_resume', $id_resume));
  $nb_tops_triche         = intval(get_field('nb_triche_resume', $id_resume));
  if ($nb_ranks > 0) {
