...
function vkzr_do_elo_vote() {
    ...
    $difference_v = $new_score_v - $elo_v;
    $difference_l = $new_score_l - $elo_l;

    update_field( 'difference_c', $difference_v, $winner );
    update_field( 'difference_c', $difference_l, $looser );
