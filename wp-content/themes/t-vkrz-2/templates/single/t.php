            ...
            <div class="nav-tournament d-flex justify-content-center align-items-center">
                ...
                <div class="btng mr-5 ml-5">
                    ...
                    <div class="btn-group justify-content-center share-t" role="group">
                        ...
                        ?>
                        <a href="https://twitter.com/intent/tweet?source=<?php echo $url_tournament; ?>&text=Viens faire ton TOP <?php echo $title_tournament; ?>:%20<?php echo $url_tournament; ?>" target="_blank" title="Tweet" class="btn btn-icon btn-outline-primary">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url_tournament; ?>" title="Partager sur Facebook" target="_blank" class="btn btn-icon btn-outline-primary">
