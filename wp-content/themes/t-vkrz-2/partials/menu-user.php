        ...
        <div class="bookmark-wrapper d-flex align-items-baseline">
            ...
            <?php elseif(is_single() && (get_post_type() == "tournoi")): ?>
                ...
                <div class="tournament-heading text-center">
                    <h3 class="mb-0 t-titre-tournoi">Top <?php echo get_numbers_of_contenders($id_tournament); ?> <span class="ico">⚔️</span> <?php the_title(); ?></h3>
                </div>
                    ...
                    <li class="dropdown-menu-footer">
                        <div class="text-center mb-2 mt-1">
                            <h6 class="font-weight-bolder mb-0">
                                Encore 728 💎 pour passer au niveau 🦤
                            </h6>
                        </div>
