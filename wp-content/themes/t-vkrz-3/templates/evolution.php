        ...
        <div class="content-body">
            <section id="pricing-plan">
                <div class="text-center">
                    ...
                    <p class="mb-4 mt-3">
                        En enchaînant les votes, tu accumules des <span class="va-high-voltage va va-z-17"></span>. Voici toutes les étapes à franchir pour devenir légendaire <span class="va va-backhand-index-pointing-down va-z-17"></span>
                        <br><br>
                        Par contre, calmons-nous <span class="va va-woozy-face va-z-17"></span> pour arriver au sommet il faudra sans doute attendre que de nouveaux moyens de gagner des <span class="va-high-voltage va va-z-17"></span> voient le jour #ProjetLongTerme
                    </p>
                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if(is_user_logged_in()): ?>
                                            <p class="card-text eh2">
                                                Maintenant que tu fais parti des Vainkeurs, il te faut 50 <span class="ico va-high-voltage va va-lg"></span> pour éclore et passer au niveau 1.
                                            </p>
                                        <?php else: ?>
                                            <p class="card-text eh2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2 d-flex align-items-center justify-content-center">
                                                <div class="need">
                                                    <span class="pricing-basic-value font-weight-bolder text-primary">50 <span class="ico va-high-voltage va va-z-30"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card basic-pricing text-center <?php if($level_user==2){echo 'popular';} ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2 d-flex align-items-center justify-content-center">
                                                <div class="need">
                                                    <span class="pricing-basic-value font-weight-bolder text-primary">500 <span class="ico va-high-voltage va va-z-30"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card basic-pricing text-center <?php if($level_user==3){echo 'popular';} ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2 d-flex align-items-center justify-content-center">
                                                <div class="need">
                                                    <span class="pricing-basic-value font-weight-bolder text-primary">2 000 <span class="ico va-high-voltage va va-z-30"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card basic-pricing text-center <?php if($level_user==4){echo 'popular';} ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2 d-flex align-items-center justify-content-center">
                                                <div class="need">
                                                    <span class="pricing-basic-value font-weight-bolder text-primary">5 000 <span class="ico va-high-voltage va va-z-30"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card basic-pricing text-center <?php if($level_user==5){echo 'popular';} ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2 d-flex align-items-center justify-content-center">
                                                <div class="need">
                                                    <span class="pricing-basic-value font-weight-bolder text-primary">35 000 <span class="ico va-high-voltage va va-z-30"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card basic-pricing text-center <?php if($level_user==6){echo 'popular';} ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2 d-flex align-items-center justify-content-center">
                                                <div class="need">
                                                    <span class="pricing-basic-value font-weight-bolder text-primary">100 000 <span class="ico va-high-voltage va va-z-30"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card basic-pricing text-center <?php if($level_user==7){echo 'popular';} ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2 d-flex align-items-center justify-content-center">
                                                <div class="need">
                                                    <span class="pricing-basic-value font-weight-bolder text-primary">450 000 <span class="ico va-high-voltage va va-z-30"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card basic-pricing text-center <?php if($level_user==8){echo 'popular';} ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2 d-flex align-items-center justify-content-center">
                                                <div class="need">
                                                    <span class="pricing-basic-value font-weight-bolder text-primary">1 MILLION<span class="ico va-high-voltage va va-z-30"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
