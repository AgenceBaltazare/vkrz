        ...
        <div class="profile-tabs d-flex justify-content-between flex-wrap mt-1 mt-md-0">
          <ul class="nav nav-pills mb-0">
            <?php if (!is_author() && !is_page(218587)) : ?>
              ...
              <?php endif; ?>
              <li class="nav-item">
                <a class="nav-link font-weight-bold <?php if (is_page(get_page_by_path('parametres'))) : echo 'btn btn-primary'; endif; ?>" href="<?php the_permalink(get_page_by_path('parametres')); ?>">
                  Editer
                </a>
              </li>
