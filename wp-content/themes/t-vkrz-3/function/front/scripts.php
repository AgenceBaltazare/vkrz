...
function load_css_js() {
    ...
    wp_enqueue_style('bootstrap-ext', get_template_directory_uri().'/assets/css/bootstrap-extended.min.css', array());
    wp_enqueue_style('theme', get_template_directory_uri().'/assets/css/theme/theme.css', array());
    wp_enqueue_style('swiper', get_template_directory_uri().'/assets/vendors/css/extensions/swiper.min.css', array());
    wp_enqueue_style('ext-swiper', get_template_directory_uri().'/assets/css/plugins/extensions/ext-component-swiper.css', array());
    wp_enqueue_style('ext-sweet-alerts', get_template_directory_uri().'/assets/css/plugins/extensions/ext-component-sweet-alerts.css', array());
    wp_enqueue_style('page-pricing', get_template_directory_uri().'/assets/css/pages/page-pricing.css', array());
    wp_enqueue_style('vertical-menu', get_template_directory_uri().'/assets/css/core/menu/menu-types/vertical-menu.css', array());
