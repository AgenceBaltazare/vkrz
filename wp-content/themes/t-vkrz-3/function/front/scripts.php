...
function load_css_js()
{
  ...
  if (is_page(array(27800, 27795, 27792, 27794, 347475))) {
  ...
  wp_enqueue_script('notification', get_template_directory_uri() . '/function/ajax/notification.js', array(), $template_version, true);
  ...
  if (is_author() || is_page(array(284946, 143788, 284948, 218587)) || is_page(get_page_by_path('tas')) || is_page(get_page_by_path('mon-compte')) || is_page(get_page_by_path('mon-compte/createur')) || is_page(get_page_by_path('mon-compte/notifications')) || is_page(get_page_by_path('mon-compte/amis'))) {
