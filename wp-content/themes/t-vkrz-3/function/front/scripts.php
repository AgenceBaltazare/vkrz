...
function load_css_js() {
    ...
    if(is_author() || is_page(array(284946, 143788, 284948, 218587)) || is_page(get_page_by_path('annonces-des-tirages-au-sort')) || is_page(get_page_by_path('mon-compte')) || is_page(get_page_by_path('mon-compte/createur'))){
