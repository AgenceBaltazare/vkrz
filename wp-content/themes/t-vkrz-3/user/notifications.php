                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="mb-1">
                          <button 
                            type="button" 
                            class="btn btn-gradient-success mr-1 notifs_statut_nouveau " 
                            spellcheck="false"
                          >
                            Nouveau
                          </button>
                          ...
                          <button 
                            type="button" 
                            class="btn btn-gradient-primary mr-1 notifs_statut_all" 
                            spellcheck="false"
                          >
                            All
                          </button>
                          ...
                          <button 
                            type="button" 
                            class="btn btn-relief-info mr-1 notifs_read_all " 
                            spellcheck="false"
                          >
                            Read All
                          </button>
