...
function load_css_js()
{
  ...
  if (is_page('Créer un Top')) {
    wp_enqueue_script('create-top', get_template_directory_uri() . '/function/ajax/create-top.js', array(), filemtime(get_template_directory() . '/function/ajax/create-top.js'), true );
  }
  if (is_page('Discuz')) {
