...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo( 'template_directory' ); ?>/assets/css/main.css?v=<?= $version; ?>">
...
?>
<body <?php body_class('cover'); ?> style="background: url(<?php echo $illu; ?>) center center no-repeat">