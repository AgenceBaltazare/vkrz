        ...
        <div class="col-12">
            <div class="row match-height">
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 0) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 0) : ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 1) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 1) : ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 2) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 2) : ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 3) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 3) : ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 4) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 4) : ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 5) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 5) : ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 6) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 6) : ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 7) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 7) : ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="card basic-pricing text-center <?php if ($level_user == 8) {
                                                                    echo 'popular';
                                                                } ?>">
                        <div class="card-body">
                            <?php if ($level_user == 8) : ?>
